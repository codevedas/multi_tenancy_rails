...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { domain: @welcome.domain, path: @welcome.path } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { domain: @welcome.domain, path: @welcome.path } }
